...
# Firebase setup
cred = credentials.Certificate("fbot-a769a-firebase-adminsdk-4t99e-8e5d535f53.json")
...
# Main function
def main():
    application = Application.builder().token("8143401362:AAEr_QlwBJ0VP_gyNVsZMCRIFTIhmBNXEc8").build()
